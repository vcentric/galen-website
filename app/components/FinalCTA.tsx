      ...
      <div className="max-w-[1100px] mx-auto bg-dark rounded-[2rem] py-16 px-12 text-center relative overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.12)] max-[768px]:py-12 max-[768px]:px-8 max-[768px]:rounded-[1.5rem] max-[480px]:py-10 max-[480px]:px-6 max-[480px]:rounded-[1.25rem]">
        ...
        <form className="mb-12" onSubmit={handleSubmit}>
          ...
          >
            <input
              type="text"
              className="flex-1 bg-none border-none outline-none text-base text-white py-3 px-0 placeholder:text-[rgba(255,255,255,0.5)] max-[768px]:text-[0.95rem] max-[480px]:text-[0.9rem] max-[480px]:py-[0.625rem] max-[480px]:px-3"
          ...
          <p className="text-[0.875rem] text-[rgba(255,255,255,0.5)] mt-3">
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="flex gap-4 flex-wrap justify-center max-[768px]:flex-col max-[768px]:w-full max-[768px]:max-w-[320px]">
            ...
            >
              ...
              <div className="flex flex-col items-start text-left">
                <span className="text-[0.75rem] text-[rgba(255,255,255,0.7)] font-normal">
                  Download on the
                </span>
                <span className="text-[1.05rem] text-white font-semibold">
                  App Store
                </span>
              </div>
            </a>
          ...
          <p className="text-[0.875rem] text-[rgba(255,255,255,0.4)] font-normal">
