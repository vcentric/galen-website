          ...
          <table className="w-full border-collapse text-left max-[900px]:min-w-[850px]">
            <thead>
              <tr className="divide-x divide-[rgba(255,255,255,0.25)]">
                <th className="w-[30%] text-center p-[clamp(1.2rem,2vw,2rem)] align-middle bg-[#f2855a] border-r border-[rgba(255,255,255,0.25)]">
                  <span className="text-lg md:text-xl font-bold text-white tracking-tight">Features</span>
                </th>

                {/* Marrow */}
                <th className="w-[17.5%] text-center p-[clamp(1.2rem,2vw,2rem)] align-middle bg-[#f2855a] border-r border-[rgba(255,255,255,0.25)]">
                  <div className="flex flex-col items-center gap-2">
                    <div className="h-[20px] md:h-[28px] flex items-center justify-center">
                      <Image src="/marrow.webp" alt="Marrow" width={80} height={40} className="max-h-full w-auto object-contain" />
                    </div>
                ...
                <th className="w-[17.5%] text-center p-[clamp(1.2rem,2vw,2rem)] align-middle bg-[#f2855a] border-r border-[rgba(255,255,255,0.25)]">
                  <div className="flex flex-col items-center gap-2">
                    <div className="h-[20px] md:h-[28px] flex items-center justify-center">
                      <Image src="/chatgpt.webp" alt="ChatGPT" width={80} height={40} className="max-h-full w-auto object-contain" />
                    </div>
                    <div className="min-h-[36px] flex items-center justify-center">
                ...
                <th className="w-[17.5%] text-center p-[clamp(1.2rem,2vw,2rem)] align-middle bg-[#f2855a] border-r border-[rgba(255,255,255,0.25)]">
                  <div className="flex flex-col items-center gap-2">
                    <div className="h-[20px] md:h-[28px] flex items-center justify-center">
                      <Image src="/openevidence.webp" alt="OpenEvidence" width={80} height={40} className="max-h-[85%] md:max-h-[90%] w-auto object-contain" />
                    </div>
                    <div className="min-h-[36px] flex items-center justify-center">
                ...
                {/* GalenAI — rightmost */}
                <th className="w-[17.5%] text-center p-[clamp(1.2rem,2vw,2rem)] align-middle bg-[#f2855a]">
                  <div className="flex flex-col items-center gap-2">
                    <div className="h-[20px] md:h-[28px] flex items-center justify-center">
                      <Image src="/galenai-icon.webp" alt="GalenAI" width={80} height={40} className="max-h-full w-auto object-contain scale-[1.1]" />
                    </div>
                    <div className="min-h-[36px] flex items-center justify-center">
