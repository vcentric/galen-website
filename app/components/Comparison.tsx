...
const Comparison = () => {
  const features: Feature[] = [
    {
      title: "Continuous AI Learning Companion",
      marrow: false,
      chatgpt: false,
      openevidence: false,
      galen: true,
    ...
    {
      title: "Competency-Aligned Learning System",
      marrow: false,
      chatgpt: false,
      openevidence: false,
      galen: true,
    ...
    {
      title: "Verified & Curriculum-Aligned Intelligence",
      marrow: true,
      chatgpt: false,
      openevidence: true,
      galen: true,
    ...
    {
      title: "Tracks Your Learning Progress & Patterns",
      marrow: false,
      chatgpt: false,
      openevidence: false,
      galen: true,
    ...
    {
      title: "Integrated Learning (Tutor + Qbanks + Cases + Flashcards)",
      marrow: false,
      chatgpt: false,
      openevidence: false,
      galen: true,
    ...
    {
      title: "Accessible Pricing (Built for Students)",
      marrow: false,
      chatgpt: false,
      openevidence: true,
      galen: true,
    ...
    {
      title: "Built for Students, Faculty & Classrooms",
      marrow: false,
      chatgpt: false,
      openevidence: false,
      galen: true,
  ...
  return (
    <section
      className="py-[clamp(3.5rem,8vw,4rem)] px-[clamp(2rem,6vw,4rem)] bg-transparent"
      id="comparison"
    >
      <div className="max-w-[1125px] mx-auto text-center">
        <div className="flex flex-col items-center">
          ...
          <h2 className="text-[clamp(1.9rem,5vw,3.25rem)] leading-[1.1] text-center font-sans font-medium text-[#222] tracking-[-0.03em] max-w-[1200px]">
            <span className="text-[#EB602D]">Your Best Choice</span> For
            <br className="hidden md:block" /> Medical Excellence &amp;
            Affordability
          </h2>
        </div>
              ...
              <tr className="divide-x divide-[rgba(255,255,255,0.25)]">
                ...
                <th className="w-[17.5%] text-center p-[clamp(1.2rem,2vw,2rem)] align-middle bg-[#2e2e2e] border-r border-[rgba(255,255,255,0.25)]">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <div className="min-h-[36px] flex items-center justify-center">
                      <span className="font-semibold text-white text-[0.8rem] md:text-[0.95rem] leading-tight text-center">
                        Traditional <br /> Ed-Tech
                      </span>
                    </div>
                  </div>
                </th>
                ...
                <th className="w-[17.5%] text-center p-[clamp(1.2rem,2vw,2rem)] align-middle bg-[#2e2e2e] border-r border-[rgba(255,255,255,0.25)]">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <div className="min-h-[36px] flex items-center justify-center">
                      <span className="font-semibold text-white text-[0.85rem] md:text-[0.95rem] leading-tight text-center">
                        Generic LLM
                      </span>
                    </div>
                  </div>
                ...
                <th className="w-[17.5%] text-center p-[clamp(1.2rem,2vw,2rem)] align-middle bg-[#2e2e2e]">
                  <div className="flex flex-col items-center gap-2">
                    <div className="relative w-[28px] h-[28px] bg-[#eb602d] shadow-sm flex items-center justify-center">
                      <Image
                    ...
                    <div className="min-h-[36px] flex items-center justify-center">
                      <span className="font-bold text-white text-[0.95rem] md:text-[1.05rem] leading-tight text-center">
                        GalenAI
                      </span>
                    </div>
                  </div>
            ...
            <tbody>
              {features.map((feature, index) => {
                ...
                return (
                  <tr
                    key={index}
                    className="group transition-colors duration-200 hover:bg-slate-50/50 divide-x divide-slate-100"
                  >
                    <td
                      className={`p-[clamp(1.2rem,2vw,1.8rem)] text-center align-middle bg-white border-r border-slate-100 ${borderClass}`}
                    >
                      <span className="font-medium text-slate-700 text-[0.95rem] md:text-[1.05rem]">
                        {feature.title}
                      </span>
                    </td>

                    <td
                      className={`px-[clamp(1.2rem,2vw,2rem)] py-[clamp(1rem,2vw,1.5rem)] text-center align-middle bg-white ${borderClass}`}
                    >
                      <div className="flex justify-center">
                        {renderIcon(feature.marrow)}
                      </div>
                    </td>
                    ...
                    <td
                      className={`px-[clamp(1.2rem,2vw,2rem)] py-[clamp(1rem,2vw,1.5rem)] text-center align-middle bg-[rgba(235,96,45,0.06)] ${borderClass}`}
                    >
                      <div className="flex justify-center">
