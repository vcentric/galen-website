...
const Footer = () => {
  ...
  return (
    <footer
      id="contact"
      className="w-full pt-[clamp(2rem,5vw,3rem)] pb-[clamp(1rem,3vw,1.5rem)] px-[clamp(2rem,6vw,4rem)] font-primary"
    >
      <div className="max-w-[1240px] mx-auto bg-[#303030] rounded-[40px] px-[clamp(1.5rem,5vw,2.5rem)] pt-[clamp(2.5rem,6vw,3rem)] pb-[clamp(2rem,5vw,2.5rem)] text-white relative overflow-hidden shadow-sm">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-8 mb-[clamp(4rem,10vw,6rem)]">
              ...
              <div className="flex flex-col gap-[clamp(0.75rem,2vw,1rem)] min-w-[120px]">
                ...
                <div className="flex flex-col gap-3">
                  {[
                    ...
                    const isStatic =
                      link.label === "About GalenAI" ||
                      link.label === "Our Mission";
                    const isJoinTeam = link.label === "Join the Team";
                    const commonClasses =
                      "flex items-center w-fit text-[0.95rem] no-underline transition-colors";

                    if (isPricing || isStatic) {
                      return (
                        <span
                          key={link.label}
                          className={`${commonClasses} text-gray-300 font-sans cursor-default`}
                        >
                          {link.label}
                        </span>
                      );
                    ...
                    if (isJoinTeam) {
                      return (
                        <div key={link.label} className="group/join relative">
                          <button
                            className={`${commonClasses} font-sans text-white cursor-default`}
                          >
                            {link.label}
                          </button>
                          <div className="absolute bottom-full left-0 mb-3 w-[290px] p-5 bg-[#404040]/95 backdrop-blur-md font-sans text-[0.92rem] leading-relaxed text-gray-200 rounded-2xl opacity-0 invisible group-hover/join:opacity-100 group-hover/join:visible transition-all duration-300 transform translate-y-2 group-hover/join:translate-y-0 z-50 shadow-2xl border border-white/10 pointer-events-none">
                            ...
                            <a
                              href="mailto:info@galenai.io"
                              className="text-white font-medium hover:underline pointer-events-auto"
                            >
                              info@galenai.io
                            </a>{" "}
                            and tell us why you want to be part of GalenAI.
                    ...
                    return (
                      <a
                        key={link.label}
                        href={link.href}
                        className={`${commonClasses} group text-gray-300 hover:text-white`}
                      >
                        {link.label}
                        <div className="overflow-hidden ml-1.5 flex items-center justify-center">
                          <ArrowUpRightIcon
                            className="w-3.5 h-3.5 -translate-x-[120%] translate-y-[120%] transition-transform duration-300 ease-out group-hover:duration-200 group-hover:ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-x-0 group-hover:translate-y-0"
                            strokeWidth={2.5}
                          />
                        </div>
                      </a>
              ...
              <div className="flex flex-col gap-[clamp(0.75rem,2vw,1rem)] min-w-[120px]">
                ...
                <div className="flex flex-col gap-3">
                  {[
                    {
                      label: "Instagram",
                      icon: <SiInstagram className="w-[18px] h-[18px]" />,
                      href: "https://www.instagram.com/galen_ai/ ",
                    },
                    {
                      label: "LinkedIn",
                      icon: <SiLinkedin className="w-[18px] h-[18px]" />,
                      href: "https://linkedin.com/company/galenai-india/",
                    },
                    {
                      label: "X",
                      icon: <SiX className="w-[18px] h-[18px]" />,
                      href: "#",
                    },
                    {
                      label: "YouTube",
          ...
          <div className="flex flex-col gap-3 w-full lg:w-auto mt-8 lg:mt-0">
            <a
              href={decorateUrl(
                "https://apps.apple.com/us/app/galenai/id6755653561",
              )}
              onClick={() => {
            ...
            >
              ...
              <div className="flex flex-col text-left">
                <span className="text-[0.65rem] uppercase tracking-wider text-gray-400 font-bold">
                  Download from
                </span>
            ...
            <a
              href={decorateUrl(
                "https://play.google.com/store/apps/details?id=com.galenai.galenai",
              )}
              onClick={() => {
      ...
      <div className="max-w-[1240px] mx-auto mt-[clamp(1rem,3vw,1.5rem)] px-[clamp(1rem,4vw,1.5rem)] flex justify-between items-center text-[#777] text-[clamp(0.75rem,1.5vw,0.85rem)] font-medium max-[600px]:flex-col max-[600px]:gap-3 max-[600px]:text-center">
        ...
        <div className="flex items-center gap-3">
          <a href="/terms" className="hover:text-[#444] transition-colors">
            Terms of Service
          </a>
          <span className="text-[#ccc] text-[0.85rem]">|</span>
          <a href="/privacy" className="hover:text-[#444] transition-colors">
            Privacy Policy
          </a>
        </div>
      </div>
