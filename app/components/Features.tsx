...
const Features = () => {
  ...
  return (
    <section
      id="features"
      className="w-full py-[clamp(4rem,10vw,4rem)] px-[clamp(2rem,6vw,4rem)] font-sans relative z-10"
    >
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-20 items-start lg:items-center">
          ...
          <div className="w-full lg:w-2/3 flex flex-col justify-center">
            ...
            <div
              key={active}
              className="animate-[fadeIn_0.6s_ease-out_forwards] mb-6 lg:mb-0 text-center lg:text-left"
            >
                        ...
                        >
                          <div className="mb-4">
                            <div className="flex items-center gap-1.5 mb-2.5">
                              ...
                              <span className="text-orange text-[8px] sm:text-[9px] font-bold tracking-[0.15em]">
                                WHAT'S NEXT
                              </span>
                            </div>

                            <div className="font-[var(--font-space-var)] font-bold mb-3 leading-[0.95]">
                              <div className="text-[30px] sm:text-[34px] tracking-tight">
                                Coming
                              </div>
                            ...
                            <p className="text-[10px] sm:text-[11px] text-[#8a8a8e] leading-[1.35] font-medium max-w-[95%]">
                              Future updates rolling out to make your medical
                              prep smarter.
                            </p>
                          </div>
                          ...
                          <div className="flex items-center gap-2 mb-3.5">
                            ...
                            <span className="text-[9px] font-bold tracking-[0.15em] text-[#555]">
                              UPCOMING
                            </span>
                          </div>
                          ...
                          <div className="flex flex-col gap-2.5">
                            {COMING_SOON_DATA.map((item, idx) => (
                              <div
                                key={idx}
                                className="flex gap-2.5 sm:gap-3 p-2 sm:p-2.5 rounded-[14px] bg-white/[0.02] border border-white/[0.08]"
                              >
        ...
        <div className="mt-8 lg:mt-12 flex justify-center">
          <a
            href={decorateUrl("/qr")}
            onClick={() => {
              trackCTAClick("try_now", {
                source: "features",
                button_type: "link",
                button_text: "Start Learning Today!",
              });
            }}
          ...
          >
            ...
            <span className="cta-arrow-container overflow-hidden flex items-center w-[clamp(3.25rem,6vw,4.25rem)] ml-4 self-center opacity-100 transition-all duration-500 ease-out">
