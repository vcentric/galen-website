  ...
  useEffect(() => {
    ...
    if (/android/i.test(userAgent)) {
      trackCTAClick("play_store", {
        source: "qr_fulfillment",
        button_type: "link",
        button_text: "QR redirect",
      });
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-6">
      ...
      <h1 className="text-xl font-semibold mb-2 tracking-tight">
        Redirecting to GalenAI...
      </h1>
      <p className="text-gray-500 text-sm">
        Detecting your device to provide the best experience.
      </p>
      <div className="mt-8">
        <p className="text-xs text-gray-400 mb-2">
          Not redirected? Click a link below:
        </p>
          ...
          <a
            ...
            onClick={() =>
              trackCTAClick("play_store", {
                source: "qr_fallback",
                button_type: "link",
                button_text: "Google Play (Android)",
              })
            }
          >
            Google Play (Android)
