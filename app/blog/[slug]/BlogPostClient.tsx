    ...
    <div className="min-h-screen bg-surface-cream">
      ...
      <div className="bg-white border-b border-black/[0.06] px-8 py-5 pt-24 max-[768px]:px-6 max-[768px]:py-4 max-[768px]:pt-20">
        <div className="max-w-[1200px] mx-auto flex items-center gap-3 font-sans text-[0.9rem] max-[768px]:text-[0.85rem]">
          <Link href="/blog" className="text-foreground/60 no-underline transition-colors duration-200 hover:text-cta">
            Blog
          </Link>
      ...
      <div className="max-w-[1200px] mx-auto px-8 py-12 grid grid-cols-[1fr_300px] gap-16 max-[1024px]:grid-cols-1 max-[1024px]:gap-12 max-[768px]:px-6 max-[768px]:py-10">
        <article>
          ...
          <div className="mt-16 pt-12 border-t border-[#e5e5e5]">
            <h4 className="font-sans text-[1.125rem] font-bold text-foreground mb-4">Share this article</h4>
            <div className="flex gap-4 flex-wrap">
              <button onClick={() => handleShare("copy")} className="flex items-center gap-2 font-sans text-[0.95rem] font-medium text-foreground/60 bg-white border border-[#e5e5e5] rounded-[0.625rem] px-5 py-3 cursor-pointer transition-all duration-200 hover:bg-surface hover:border-cta hover:text-cta max-[480px]:text-[0.875rem] max-[480px]:px-4 max-[480px]:py-[0.625rem]">
              ...
              <button onClick={() => handleShare("linkedin")} className="flex items-center gap-2 font-sans text-[0.95rem] font-medium text-foreground/60 bg-white border border-[#e5e5e5] rounded-[0.625rem] px-5 py-3 cursor-pointer transition-all duration-200 hover:bg-surface hover:border-cta hover:text-cta max-[480px]:text-[0.875rem] max-[480px]:px-4 max-[480px]:py-[0.625rem]">
                <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19 3A2 2 0 0 1 21 5V19A2 2 0 0 1 19 21H5A2 2 0 0 1 3 19V5A2 2 0 0 1 5 3H19M18.5 18.5V13.2A3.26 3.26 0 0 0 15.24 9.94C14.39 9.94 13.4 10.46 12.92 11.24V10.13H10.13V18.5H12.92V13.57C12.92 12.8 13.54 12.17 14.31 12.17A1.4 1.4 0 0 1 15.71 13.57V18.5H18.5M6.88 8.56A1.68 1.68 0 0 0 8.56 6.88C8.56 5.95 7.81 5.19 6.88 5.19A1.69 1.69 0 0 0 5.19 6.88C5.19 7.81 5.95 8.56 6.88 8.56M8.27 18.5V10.13H5.5V18.5H8.27Z" />
                </svg>
                LinkedIn
              </button>
              <button onClick={() => handleShare("twitter")} className="flex items-center gap-2 font-sans text-[0.95rem] font-medium text-foreground/60 bg-white border border-[#e5e5e5] rounded-[0.625rem] px-5 py-3 cursor-pointer transition-all duration-200 hover:bg-surface hover:border-cta hover:text-cta max-[480px]:text-[0.875rem] max-[480px]:px-4 max-[480px]:py-[0.625rem]">
                <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="currentColor">
        ...
        <aside className="sticky top-8 h-fit max-[1024px]:static max-[1024px]:grid max-[1024px]:grid-cols-2 max-[1024px]:gap-8 max-[768px]:grid-cols-1">
          ...
          <div className="bg-cta/15 backdrop-blur-[20px] border border-cta/25 rounded-[1.25rem] p-8 text-center shadow-[0_8px_24px_rgba(235,96,45,0.12),inset_0_1px_0_rgba(255,255,255,0.3)]">
            <h4 className="font-sans text-[1.25rem] font-bold text-cta mb-3">Try GalenAI</h4>
      ...
      {relatedPosts.length > 0 && (
        <div className="bg-white px-8 py-16 mt-16 max-[768px]:px-6 max-[768px]:py-12">
          <div className="max-w-[1200px] mx-auto">
            <h3 className="font-sans text-[2rem] font-bold text-foreground mb-8">Related Articles</h3>
