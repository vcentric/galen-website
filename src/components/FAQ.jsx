...
const FAQ = () => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            links: [
                { label: "iOS App", url: "https://apps.apple.com/in/app/galenai/id6755653561" },
                { label: "Android App", url: "https://play.google.com/store/apps/details?id=com.galenai.galenai" }
            ]
        },
        {
        ...
        <section className="faq-section">
            <div className="faq-container">
                <div className="faq-header">
                    ...
                    <p className="faq-subheading">Everything you need to know about GalenAI</p>
                </div>
